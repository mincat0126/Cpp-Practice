...
<img width="321" height="168" alt="image" src="https://github.com/user-attachments/assets/10c52cfd-69ca-4136-b4ff-a5e70c3b1b4d" />
<br><br><br>
...
<img width="250" height="148" alt="image" src="https://github.com/user-attachments/assets/b7d3efbb-ed31-43d9-b9e6-c0daf97193c6" />
<br><br><br>
...
void main(void)
{
    char str1[5] = "abcd";              //<실행결과>
    char str2[10] = "123456789";       //abcd
    strncpy(str2, str1, 9);                  
    puts(str2);
}
</pre>
<img width="250" height="185" alt="image" src="https://github.com/user-attachments/assets/5adb3525-0bda-4cd4-a142-2255f645e1f3" />
<br><br><br>
...
void main(void)
{
	...
	strcat(str,"마바사");
                                  //<실행결과>
	printf("%s", str);            //가나다라마바사
}</pre><br><br>

**strncat**: 지정한 길이만큼 한 문자열 끝에 다른 문자열을 덧붙이는 함수.  
...
void main(void)
{
	char str[20] = "가나다라";      //<실행결과>
	strncat(str,"마바사",4);        //가나다라마바
