...
> 이름에 move가 포함되어 있지만 원본이 삭제되는 것은 아니며 복사된다.
...
void main(void)
{
    ...
    memcpy(str + 8, str2, strlen(str2));     //<실행결과>
    puts(str);                               //You are very beautiful
}</pre>
<img width="476" height="167" alt="image" src="https://github.com/user-attachments/assets/c2ce46ac-8c90-43fd-b185-f5a9790ef600" />
